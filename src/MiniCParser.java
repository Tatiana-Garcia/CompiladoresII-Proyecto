...
public class MiniCParser extends Parser {
	...
	public static final int
		...
		RULE_exprStmt = 16, RULE_expr = 17, RULE_logicalOrExpr = 18, RULE_logicalAndExpr = 19, 
	...
	public final CompoundStmtContext compoundStmt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4383017185250L) != 0)) {
				{
				setState(115);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final MultiplicativeExprContext multiplicativeExpr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 12884901920L) != 0)) {
				{
				{
				setState(227);
				_la = _input.LA(1);
